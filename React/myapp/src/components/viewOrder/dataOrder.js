...
const data = [
    {
        ...
        listFood: [
            ...
            {img: cappuccino,name:"Cappuccino",type: "Nuoc", price: 10000, num: 2},
            {img: Coca,name:"Coca cola",type: "Nuoc", price: 10000, num: 2},
            {img: coctailRose,name:"Cocktail hoa hồng",type: "Nuoc", price: 10000, num: 2},
        ]
    },
    {
        dateOrder: "29/02/2021", 
        ...
        listFood: [
            ...
            {img: GaRan,name:"Gà rán",type: "DoAn", price: 10000, num: 1},
            {img: Hamburger,name:"Hamburger",type: "DoAn", price: 10000, num: 1},
            {img: KhoaiTayChien,name:"Khoai tây chiên",type: "DoAn", price: 10000, num: 1},
        ]
    },
    {
        dateOrder: "29/02/2021", 
        ...
        listFood: [
            ...
            {img: nemCongChaPhuong,name:"Nem công chả phượng",type: "DoAn", price: 10000, num: 3},
            {img: nuocCam,name:"Nước cam",type: "Nuoc", price: 10000, num: 3},
            {img: comboGiangSinh ,name:"Combo Giáng sinh",type: "Combo", price: 100000, num: 1},
        ]
    },
    {
        dateOrder: "29/02/2021", 
        ...
        listFood: [
            ...
            {img: Sinhto ,name:"Sinh tố",type: "Nuoc", price: 10000, num: 5},
            {img: sprite,name:"Sprite",type: "Nuoc", price: 10000, num: 5},
            {img: traiCayDam,name:"Trái cây dầm",type: "Nuoc", price: 10000, num: 5},
        ]
    },
];
export default data;