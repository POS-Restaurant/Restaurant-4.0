...
const FoodItem = (props) => {
    ...
    return (
        <div className={styles.itemContainer}>
            ...
            <Button variant="contained" onClick={()=>{localStorage.setItem("currentFood",JSON.stringify(props)); console.log(props); setPopUp(true); }} className={`${styles.btn} ${styles.btn1}`} >Chỉnh sửa</Button>
